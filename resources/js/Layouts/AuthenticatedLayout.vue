                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('chi-nhanh.index')" :active="route().current('chi-nhanh.index')">
                                    Chi nhánh
                                </NavLink>
                                <NavLink :href="route('lop-hoc.index')" :active="route().current('lop-hoc.index')">
                                    Lớp
                                </NavLink>
                                <NavLink :href="route('giao-vien.index')" :active="route().current('giao-vien.index')">
                                    Giáo viên
                                </NavLink>
                                <NavLink :href="route('hoc-vien.index')" :active="route().current('hoc-vien.index')">
                                    Học viên
                                </NavLink>
